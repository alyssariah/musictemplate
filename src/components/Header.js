        ...
        <>
            ...
            <nav id="fullNav" className="sticky">
                <ul id="dropdown1" className="dropdown-content">
                    <Link to='/lessons'><a data-target="dropdown1">Lessons<i className="material-icons right">arrow_drop_down</i></a> </Link>
                ...
                <a class="dropdown-trigger" href="#!" data-target="dropdown1">Lessons<i className="material-icons right">arrow_drop_down</i></a>
